"""
Modified from https://github.com/facebookresearch/dino/blob/main/main_dino.py

Modifications include:
    - Dataset specific normalization
    - Modfication to work with multichannel tiffs
"""
import argparse
import os
import sys
...
def get_args_parser():
    ...
    # Input type
    parser.add_argument('--input_type', default='oct', type=str,
        help="What input data type is DINO learning. Options are ['multichannel', 'oct', 'ffpe']")
    return parser
...
def train_dino(args):
    ...
    if args.input_type == 'multichannel':
        ...
        dataset = MultichannelImageDataset(
            args.data_path, transform=transform, pad=False, return_dummy_y=True)
    else:
